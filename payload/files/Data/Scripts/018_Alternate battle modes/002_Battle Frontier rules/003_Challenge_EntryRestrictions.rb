...
class NicknameClause
  ...
  def errorMessage
    return _INTL("Sem apelidos idênticos.")
  end
end
...
class SameSpeciesClause
  ...
  def errorMessage
    return _INTL("Os Pokémon devem ser da mesma espécie.")
  end
end
...
class SpeciesClause
  ...
  def errorMessage
    return _INTL("Os Pokémon não podem ser da mesma espécie.")
  end
end
...
class TotalLevelRestriction
  ...
  def errorMessage
    return _INTL("Os levels combinados excedem {1}.", @level)
  end
end
...
class ItemClause
  ...
  def errorMessage
    return _INTL("Sem held items idênticos.")
  end
end
