...
def pbDisplayGoldWindow(msgwindow)
  ...
  goldwindow = Window_AdvancedTextPokemon.new(_INTL("Dinheiro:\n<ar>{1}</ar>", moneyString))
...
def pbDisplayCoinsWindow(msgwindow, goldwindow)
  ...
  coinwindow = Window_AdvancedTextPokemon.new(_INTL("Moedas:\n<ar>{1}</ar>", coinString))
...
def pbDisplayBattlePointsWindow(msgwindow)
  ...
  pointswindow = Window_AdvancedTextPokemon.new(_INTL("Pontos de batalha:\n<ar>{1}</ar>", pointsString))
  pointswindow.setSkin("Graphics/Windowskins/goldskin")
  pointswindow.resizeToFit(pointswindow.text, Graphics.width)
  pointswindow.width = 160 if pointswindow.width <= 160
  if msgwindow.y == 0
...
def pbDisplayQuestPointsWindow(msgwindow)
  ...
  pointswindow = Window_AdvancedTextPokemon.new(_INTL("Pontos de quest:\n<ar>{1}</ar>", pointsString))
  pointswindow.setSkin("Graphics/Windowskins/goldskin")
  pointswindow.resizeToFit(pointswindow.text, Graphics.width)
  pointswindow.width = 160 if pointswindow.width <= 160
  if msgwindow.y == 0
...
def pbConfirmMessage(message, &block)
  return (pbMessage(message, [_INTL("Sim"), _INTL("Não")], 2, &block) == 0)
end

def pbConfirmMessageSerious(message, &block)
  return (pbMessage(message, [_INTL("Não"), _INTL("Sim")], 1, &block) == 1)
end
