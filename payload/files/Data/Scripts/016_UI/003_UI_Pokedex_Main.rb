...
=end
  ...
  def pbRefresh
    ...
    if @searchResults
      textpos.push([_INTL("Resultados"),112,302,2,base,shadow])
      textpos.push([@dexlist.length.to_s,112,334,2,base,shadow])
    else
      textpos.push([_INTL("Vistos:"),42,302,0,base,shadow])
      textpos.push([$Trainer.pokedex.seen_count(pbGetPokedexRegion).to_s,182,302,1,base,shadow])
      textpos.push([_INTL("Obtidos:"),42,334,0,base,shadow])
  ...
  def pbRefreshDexSearch(params,_index)
    ...
    # Write various bits of text
    textpos = [
       [_INTL("Busca"),Graphics.width/2,-2,2,base,shadow],
       [_INTL("Ordem"),136,52,2,base,shadow],
       [_INTL("Nome"),58,110,2,base,shadow],
       [_INTL("Tipo"),58,162,2,base,shadow],
       [_INTL("Altura"),58,214,2,base,shadow],
       [_INTL("Peso"),58,266,2,base,shadow],
       [_INTL("Cor"),326,110,2,base,shadow],
       [_INTL("Forma"),454,162,2,base,shadow],
       [_INTL("Redefinir"),80,338,2,base,shadow,1],
