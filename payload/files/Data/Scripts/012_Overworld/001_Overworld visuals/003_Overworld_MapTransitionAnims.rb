...
def pbStartOver(gameover=false)
  ...
  if isOnPinkanIsland()
    if $game_switches[SWITCH_PINKAN_SIDE_POLICE]
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Ei, você está bem aí? Vou te levar de volta ao cais."))
    else
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Ei, você está bem aí? Vou te levar de volta à praia."))
    end
  ...
  if $PokemonGlobal.pokecenterMapId && $PokemonGlobal.pokecenterMapId>=0
    if gameover
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Depois dessa derrota infeliz, você volta correndo para um Pokémon Center."))
    else
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Você volta correndo para um Pokémon Center, protegendo seus Pokémon exaustos de qualquer perigo..."))
    end
    pbCancelVehicles
    ...
    if gameover
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Depois dessa derrota infeliz, você volta correndo para casa."))
    else
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]Você volta correndo para casa, protegendo seus Pokémon exaustos de qualquer perigo..."))
    end
    if homedata
      pbCancelVehicles
      pbRemoveDependencies
