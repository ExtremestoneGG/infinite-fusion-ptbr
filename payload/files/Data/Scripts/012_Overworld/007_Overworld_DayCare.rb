...
def pbDayCareDeposit(index)
  ...
  raise _INTL("Não há espaço para deixar um Pokémon.")
end

def pbDayCareWithdraw(index)
  if !$PokemonGlobal.daycare[index][0]
    raise _INTL("Não há nenhum Pokémon aqui...")
  elsif $Trainer.party_full?
    raise _INTL("Não há espaço para trazer esse Pokémon de volta...")
  else
...
def pbDayCareGenerateEgg
  ...
  raise _INTL("Não há espaço para receber o Egg.") if $Trainer.party_full?
