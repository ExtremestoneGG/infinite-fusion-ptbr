...
GameData::BodyShape.register({
  :id        => :Serpentine,
  :id_number => 2,
  :name      => _INTL("Serpentino")
})

GameData::BodyShape.register({
  :id        => :Finned,
  :id_number => 3,
  :name      => _INTL("Com barbatanas")
})

GameData::BodyShape.register({
  :id        => :HeadArms,
  :id_number => 4,
  :name      => _INTL("Cabeça e braços")
})

GameData::BodyShape.register({
  :id        => :HeadBase,
  :id_number => 5,
  :name      => _INTL("Cabeça e base")
})

GameData::BodyShape.register({
  :id        => :BipedalTail,
  :id_number => 6,
  :name      => _INTL("Bípede com cauda")
})

GameData::BodyShape.register({
  :id        => :HeadLegs,
  :id_number => 7,
  :name      => _INTL("Cabeça e pernas")
})

GameData::BodyShape.register({
  :id        => :Quadruped,
  :id_number => 8,
  :name      => _INTL("Quadrúpede")
})
...
GameData::BodyShape.register({
  :id        => :Multiped,
  :id_number => 10,
  :name      => _INTL("Múltiplas pernas")
})

GameData::BodyShape.register({
  :id        => :MultiBody,
  :id_number => 11,
  :name      => _INTL("Múltiplos corpos")
})
...
GameData::BodyShape.register({
  :id        => :MultiWinged,
  :id_number => 13,
  :name      => _INTL("Múltiplas asas")
})

GameData::BodyShape.register({
  :id        => :Insectoid,
  :id_number => 14,
  :name      => _INTL("Insetoide")
})
