  ...
  def pbEndOfBattle
    ...
    when 1
      ...
      if trainerBattle?
        ...
        case @opponent.length
        when 1
          pbDisplayPaused(_INTL("Você derrotou {1}!",@opponent[0].full_name))
        when 2
          pbDisplayPaused(_INTL("Você derrotou {1} e {2}!",@opponent[0].full_name,
             @opponent[1].full_name))
        when 3
          pbDisplayPaused(_INTL("Você derrotou {1}, {2} e {3}!",@opponent[0].full_name,
