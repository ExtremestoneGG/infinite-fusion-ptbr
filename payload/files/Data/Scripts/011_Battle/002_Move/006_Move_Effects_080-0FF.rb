...
class PokeBattle_Move_094 < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    ...
    if !target.canHeal?
      @battle.pbDisplay(_INTL("Mas falhou!"))
      return true
    end
    return false
  end
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("O HP de {1} foi restaurado.",target.pbThis))
  end
...
class PokeBattle_Move_09C < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} está pronto para ajudar {2}!",user.pbThis,target.pbThis(true)))
  end
end
...
class PokeBattle_Move_09D < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("O poder da eletricidade foi enfraquecido!"))
  end
end
...
class PokeBattle_Move_09E < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("O poder do fogo foi enfraquecido!"))
  end
end
...
class PokeBattle_Move_0A1 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("Lucky Chant protegeu {1} de golpes cr?ticos!",user.pbTeam(true)))
  end
end
...
class PokeBattle_Move_0A2 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} aumentou a Defesa de {2}!",@name,user.pbTeam(true)))
  end
end
...
class PokeBattle_Move_0A3 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} aumentou a Defesa Especial de {2}!",@name,user.pbTeam(true)))
  end
end
...
class PokeBattle_Move_0A6 < PokeBattle_Move
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} mirou em {2}!",user.pbThis,target.pbThis(true)))
  end
end
...
class PokeBattle_Move_0A7 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} foi identificado!",target.pbThis))
  end
end
...
class PokeBattle_Move_0AE < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    if !target.lastRegularMoveUsed ||
      ...
      @battle.pbDisplay(_INTL("O movimento espelhado falhou!"))
      return true
    end
    return false
  end
...
class PokeBattle_Move_0B1 < PokeBattle_Move
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} se envolveu com Magic Coat!",user.pbThis))
  end
end
...
class PokeBattle_Move_0B2 < PokeBattle_Move
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} espera um alvo fazer um movimento!",user.pbThis))
  end
end
...
class PokeBattle_Move_0B3 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    @battle.pbDisplay(_INTL("{1} se transformou em {2}!", @name, GameData::Move.get(@npMove).name))
...
class PokeBattle_Move_0B7 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} foi submetido a tormento!",target.pbThis))
...
class PokeBattle_Move_0B8 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} selou qualquer golpe que compartilhe com o alvo!",user.pbThis))
  end
end
...
class PokeBattle_Move_0B9 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{2} de {1} foi desabilitado!",target.pbThis,
...
class PokeBattle_Move_0BA < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    ...
    if Settings::MECHANICS_GENERATION >= 6 && target.hasActiveAbility?(:OBLIVIOUS) &&
      ...
      if PokeBattle_SceneConstants::USE_ABILITY_SPLASH
        ...
        @battle.pbDisplay(_INTL("Mas falhou por causa de {2} de {1}!",
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} caiu na provocação!",target.pbThis))
    target.pbItemStatusCureCheck
  end
end
...
class PokeBattle_Move_0BB < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} foi impedido de se curar!",target.pbThis))
    target.pbItemStatusCureCheck
  end
end
...
#         "0AE",   # Mirror Move                                     # See above
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} recebeu um encore!",target.pbThis))
    target.pbItemStatusCureCheck
  end
end
...
class PokeBattle_Move_0C3 < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} levantou um redemoinho!",user.pbThis))
  end
end
...
class PokeBattle_Move_0C4 < PokeBattle_TwoTurnMove
  ...
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} absorveu luz solar!",user.pbThis))
  end
...
class PokeBattle_Move_0C5 < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} ficou envolto por uma luz congelante!",user.pbThis))
  end
...
class PokeBattle_Move_0C6 < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} ficou envolto por ar congelante!",user.pbThis))
  end
...
class PokeBattle_Move_0C7 < PokeBattle_TwoTurnMove
  ...
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} ficou envolto por uma luz intensa!",user.pbThis))
  end
...
class PokeBattle_Move_0C8 < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} recolheu a cabe?a!",user.pbThis))
  end
...
class PokeBattle_Move_0C9 < PokeBattle_TwoTurnMove
  ...
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} voou alto!",user.pbThis))
  end
end
...
class PokeBattle_Move_0CA < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} cavou para baixo da terra!",user.pbThis))
  end
end
...
class PokeBattle_Move_0CB < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} se escondeu debaixo d'?gua!",user.pbThis))
  end
end
...
class PokeBattle_Move_0CC < PokeBattle_TwoTurnMove
  ...
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} saltou!",user.pbThis))
  end
...
class PokeBattle_Move_0CD < PokeBattle_TwoTurnMove
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} desapareceu instantaneamente!",user.pbThis))
  end
...
class PokeBattle_Move_0CE < PokeBattle_TwoTurnMove
  ...
  def pbChargingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} levou {2} para o c?u!",user.pbThis,targets[0].pbThis(true)))
  end

  def pbAttackingTurnMessage(user,targets)
    @battle.pbDisplay(_INTL("{1} foi libertado de Sky Drop!",targets[0].pbThis))
  end
...
class PokeBattle_Move_0CF < PokeBattle_Move
  def pbEffectAgainstTarget(user,target)
    ...
    # Message
    msg = _INTL("{1} ficou preso no v?rtice!",target.pbThis)
    case @id
    when :BIND
      msg = _INTL("{1} foi espremido por {2}!",target.pbThis,user.pbThis(true))
    when :CLAMP
      msg = _INTL("{1} prendeu {2}!",user.pbThis,target.pbThis(true))
    when :FIRESPIN
      msg = _INTL("{1} ficou preso no v?rtice de fogo!",target.pbThis)
    when :INFESTATION
      msg = _INTL("{1} foi infestado por {2}!",target.pbThis,user.pbThis(true))
    when :MAGMASTORM
      msg = _INTL("{1} ficou preso por Magma Storm!",target.pbThis)
    when :SANDTOMB
      msg = _INTL("{1} ficou preso por Sand Tomb!",target.pbThis)
    when :WHIRLPOOL
      msg = _INTL("{1} ficou preso no v?rtice!",target.pbThis)
    when :WRAP
      msg = _INTL("{1} foi enrolado por {2}!",target.pbThis,user.pbThis(true))
    end
...
class PokeBattle_Move_0D1 < PokeBattle_Move
  def pbEffectGeneral(user)
    ...
    user.currentMove = @id
    @battle.pbDisplay(_INTL("{1} causou um alvoroço!",user.pbThis))
  ...
  def pbEffectAfterAllHits(user,target)
    ...
    if user.effects[PBEffects::Outrage]>0
      ...
      if user.effects[PBEffects::Outrage]==0 && user.pbCanConfuseSelf?(false)
        user.pbConfuse(_INTL("{1} ficou confuso por fadiga!",user.pbThis))
      end
    end
  end
end
...
class PokeBattle_Move_0D4 < PokeBattle_FixedDamageMove
  ...
  def pbMoveFailed?(user,targets)
    ...
    if targets.length==0
      @battle.pbDisplay(_INTL("Mas não havia alvo..."))
      user.effects[PBEffects::Bide] = 0   # No need to reset other Bide variables
      return true
    end
    return false
  ...
  def pbDisplayUseMessage(user)
    if @damagingTurn   # Attack turn
      @battle.pbDisplayBrief(_INTL("{1} liberou energia!",user.pbThis))
    elsif user.effects[PBEffects::Bide]>1   # Charging turns
      @battle.pbDisplayBrief(_INTL("{1} está armazenando energia!",user.pbThis))
    else
...
class PokeBattle_Move_0D9 < PokeBattle_HealingMove
  ...
  def pbEffectGeneral(user)
    user.pbSleepSelf(_INTL("{1} dormiu e recuperou a saúde!",user.pbThis),3)
    super
  end
end
...
class PokeBattle_Move_0DA < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} se envolveu com um v?u de ?gua!",user.pbThis))
  end
end
...
class PokeBattle_Move_0DB < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} plantou suas ra?zes!",user.pbThis))
  end
end
...
class PokeBattle_Move_0DC < PokeBattle_Move
  def pbFailsAgainstTarget?(user,target)
    if target.effects[PBEffects::LeechSeed]>=0
      @battle.pbDisplay(_INTL("{1} evitou o ataque!",target.pbThis))
      return true
    end
    if target.pbHasType?(:GRASS)
      @battle.pbDisplay(_INTL("Isso não afeta {1}...",target.pbThis(true)))
      return true
    end
    return false
  end
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} foi semeado!",target.pbThis))
  end
end
...
class PokeBattle_Move_0DE < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    if !target.asleep?
      @battle.pbDisplay(_INTL("{1} não foi afetado!",target.pbThis))
      return true
    end
    return false
  end
...
class PokeBattle_Move_0DF < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    if target.hp==target.totalhp
      @battle.pbDisplay(_INTL("O HP de {1} está cheio!",target.pbThis))
      return true
  ...
  def pbMoveFailed?(user,targets)
    if !@battle.moldBreaker
      ...
      if bearer!=nil
        ...
        if PokeBattle_SceneConstants::USE_ABILITY_SPLASH
          @battle.pbDisplay(_INTL("{1} não pode usar {2}!",user.pbThis,@name))
        else
          @battle.pbDisplay(_INTL("{1} não pode usar {2} por causa de {4} de {3}!",
...
class PokeBattle_Move_0E5 < PokeBattle_Move
  ...
  def pbShowAnimation(id,user,targets,hitNum=0,showAnimation=true)
    super
    @battle.pbDisplay(_INTL("Todos os Pokémon que ouvirem a canção desmaiarão em três turnos!"))
  end
end
...
class PokeBattle_Move_0E6 < PokeBattle_Move
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} quer que o alvo guarde rancor!",user.pbThis))
  end
end
...
class PokeBattle_Move_0E7 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    @battle.pbDisplay(_INTL("{1} espera levar o atacante junto!",user.pbThis))
  end
end
...
class PokeBattle_Move_0E8 < PokeBattle_ProtectMove
  ...
  def pbProtectMessage(user)
    @battle.pbDisplay(_INTL("{1} se preparou!",user.pbThis))
  end
end
...
class PokeBattle_Move_0EA < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    @battle.pbDisplay(_INTL("{1} fugiu da batalha!",user.pbThis))
...
class PokeBattle_Move_0EB < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    if target.hasActiveAbility?(:SUCTIONCUPS) && !@battle.moldBreaker
      @battle.pbShowAbilitySplash(target)
      if PokeBattle_SceneConstants::USE_ABILITY_SPLASH
        @battle.pbDisplay(_INTL("{1} se ancorou!",target.pbThis))
      else
        @battle.pbDisplay(_INTL("{1} se ancorou com {2}!",target.pbThis,target.abilityName))
      end
      @battle.pbHideAbilitySplash(target)
      return true
    end
    if target.effects[PBEffects::Ingrain]
      @battle.pbDisplay(_INTL("{1} se ancorou com suas ra?zes!",target.pbThis))
      return true
    end
    if !@battle.canRun
      @battle.pbDisplay(_INTL("Mas falhou!"))
  ...
  def pbSwitchOutTargetsEffect(user,targets,numHits,switchedBattlers)
    ...
    targets.each do |b|
      ...
      @battle.pbDisplay(_INTL("{1} foi arrastado para fora!",b.pbThis))
...
class PokeBattle_Move_0EE < PokeBattle_Move
  def pbEndOfMoveUsageEffect(user,targets,numHits,switchedBattlers)
    ...
    return if !@battle.pbCanChooseNonActive?(user.index)
    @battle.pbDisplay(_INTL("{1} voltou para {2}!",user.pbThis,
...
class PokeBattle_Move_0EF < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} não pode mais escapar!",target.pbThis))
  end
...
class PokeBattle_Move_0F0 < PokeBattle_Move
  ...
  def pbEffectAfterAllHits(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} derrubou {2}!",target.pbThis,itemName))
  end
end
...
class PokeBattle_Move_0F1 < PokeBattle_Move
  def pbEffectAfterAllHits(user,target)
    ...
    target.pbRemoveItem(false)
    @battle.pbDisplay(_INTL("{1} roubou {3} de {2}!",user.pbThis,target.pbThis(true),itemName))
...
class PokeBattle_Move_0F2 < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    ...
    if target.hasActiveAbility?(:STICKYHOLD) && !@battle.moldBreaker
      @battle.pbShowAbilitySplash(target)
      if PokeBattle_SceneConstants::USE_ABILITY_SPLASH
        @battle.pbDisplay(_INTL("Mas não conseguiu afetar {1}!",target.pbThis(true)))
      else
        @battle.pbDisplay(_INTL("Mas não conseguiu afetar {1} por causa de {2}!",
           target.pbThis(true),target.abilityName))
      end
      @battle.pbHideAbilitySplash(target)
      return true
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} trocou itens com o oponente!",user.pbThis))
    @battle.pbDisplay(_INTL("{1} obteve {2}.",user.pbThis,oldTargetItemName)) if oldTargetItem
    @battle.pbDisplay(_INTL("{1} obteve {2}.",target.pbThis,oldUserItemName)) if oldUserItem
    user.pbHeldItemTriggerCheck
...
class PokeBattle_Move_0F3 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} recebeu {2} de {3}!",target.pbThis,itemName,user.pbThis(true)))
    target.pbHeldItemTriggerCheck
  end
end
...
class PokeBattle_Move_0F4 < PokeBattle_Move
  def pbEffectAfterAllHits(user,target)
    ...
    itemName = target.itemName
    target.pbRemoveItem
    @battle.pbDisplay(_INTL("{1} roubou e comeu {2} do alvo!",user.pbThis,itemName))
...
class PokeBattle_Move_0F5 < PokeBattle_Move
  def pbEffectWhenDealingDamage(user,target)
    ...
    target.pbRemoveItem
    @battle.pbDisplay(_INTL("{2} de {1} foi incinerado!",target.pbThis,target.itemName))
  end
end
...
class PokeBattle_Move_0F6 < PokeBattle_Move
  ...
  def pbEffectGeneral(user)
    ...
    if itemName.starts_with_vowel?
      @battle.pbDisplay(_INTL("{1} encontrou um {2}!",user.pbThis,itemName))
    else
      @battle.pbDisplay(_INTL("{1} encontrou um {2}!",user.pbThis,itemName))
    end
    user.pbHeldItemTriggerCheck
...
class PokeBattle_Move_0F7 < PokeBattle_Move
  ...
  def pbDisplayUseMessage(user)
    ...
    if !@willFail
      @battle.pbDisplay(_INTL("{1} arremessou {2}!",user.pbThis,user.itemName))
    end
  end
...
class PokeBattle_Move_0F8 < PokeBattle_Move
  ...
  def pbEffectAgainstTarget(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} não pode mais usar itens!",target.pbThis))
  end
end
...
class PokeBattle_Move_0F9 < PokeBattle_Move
  def pbEffectGeneral(user)
    if @battle.field.effects[PBEffects::MagicRoom]>0
      ...
      @battle.pbDisplay(_INTL("A área voltou ao normal!"))
    else
      @battle.field.effects[PBEffects::MagicRoom] = 5
      @battle.pbDisplay(_INTL("Criou uma área bizarra onde os itens segurados dos Pokémon perdem seus efeitos!"))
    end
  end
