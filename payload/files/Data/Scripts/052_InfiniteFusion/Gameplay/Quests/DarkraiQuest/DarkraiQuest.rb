...
def getNextLunarFeatherHint()
  ...
  case nb_feathers
  when 0
    return _INTL("Encontre a primeira pena na moradia mais ao norte do porto dos pores do sol requintados...")
  when 1
    return _INTL("Em meio a um berçário para jovens Pokémon, a segunda pena se esconde, cercada de inocência.")
  when 2
    return _INTL("Encontre a próxima na hospedaria onde a água encontra o descanso.")
  when 3
    return _INTL("Encontre a próxima dentro da casa solitária na cidade à beira da civilização.")
  when 4
    return _INTL("A pena final está de volta no refúgio dos Pokémon órfãos...")
  else
    return _INTL("Deite-se na cama... Traga-me as penas...")
  end
end