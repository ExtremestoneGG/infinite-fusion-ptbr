...
def selectHairstyle(all_unlocked = false)
  ...
  hat = $Trainer.hat
  commands = ["Próximo estilo", "Estilo anterior", "Alternar chapéu", "Voltar"]
  previous_input = 0
...
def selectHairColor
  ...
  display_outfit_preview()
  hat = $Trainer.hat
  commands = ["Trocar cor base", "Subir", "Descer", "Alternar chapéu", "Remover tintura", "Confirmar", "Deixa pra lá"]
  previous_input = 0
...
def selectHatColor(secondary_hat=false)
  ...
  display_outfit_preview()
  commands = ["Subir", "Descer", "Redefinir", "Confirmar", "Deixa pra lá"]
  previous_input = 0
  while (true)
    choice = pbShowCommands(nil, commands, commands.length, previous_input)
    previous_input = choice
...
def selectHat(all_unlocked = false)
  selector = OutfitSelector.new
  display_outfit_preview()
  commands = ["Próximo chapéu", "Chapéu anterior", "Remover chapéu", "Voltar"]
  previous_input = 0
  while (true)
    choice = pbShowCommands(nil, commands, commands.length, previous_input)
    previous_input = choice
...
def selectClothes(all_unlocked = false)
  selector = OutfitSelector.new
  display_outfit_preview()
  commands = ["Próximo", "Anterior"]
  #commands << "Remove clothes (DEBUG)" if $DEBUG
  commands << "Remover" if $DEBUG
  commands << "Voltar"
  previous_input = 0
  while (true)
    choice = pbShowCommands(nil, commands, commands.length, previous_input)
