...
- The recommended release ZIP excludes `.bat` files; BAT/PowerShell installation is packaged separately.
...
- O ZIP recomendado da release não inclui arquivos `.bat`; a instalação BAT/PowerShell fica em um pacote separado.
