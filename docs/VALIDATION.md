...
Release 1.1.4 passed the following checks:
...
- v1.1.4 fixes `18/18` battle text strings from the current screenshot report set.
...
A versao 1.1.4 passou pelas seguintes checagens:
...
- As descricoes de especies/fusoes da Pokedex ficam para um projeto futuro e nao contam como concluidas na v1.1.4.
- Nomes das Natures e telas de Options/configuracao ficam preservados em ingles/default na v1.1.4 por estabilidade.
...
- A v1.1.4 corrige `18/18` textos de batalha do conjunto atual de prints reportados.
