...
`PTBR-Translation-BAT-v1.1.6.zip`

### Manual BAT Tutorial

1. Download `PTBR-Translation-BAT-v1.1.6.zip` from the Releases page.
...
1. Baixe `PTBR-Translation-BAT-v1.1.6.zip` pela página de Releases.
