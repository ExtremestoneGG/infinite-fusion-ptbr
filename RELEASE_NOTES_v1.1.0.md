...
Quality update for the public fan-made Brazilian Portuguese translation release.
...
This package does not include Pokemon Infinite Fusion itself. Download the game only from the official Pokemon Infinite Fusion Discord maintained by the developers.

Release assets:

- `InfiniteFusionPTBRInstaller-v1.1.0.exe`: recommended single-file graphical installer. No `.bat` files are included in this download.
- `PTBR-Translation-BAT-v1.1.0.zip`: separate BAT/PowerShell package with script tutorial and restore helper.

## Portugues

Atualizacao de qualidade da traducao fanmade publica em Portugues do Brasil.
...
- Relatorio de validacao atualizado.

Este pacote nao inclui o Pokemon Infinite Fusion. Baixe o jogo somente pelo Discord oficial de Pokemon Infinite Fusion mantido pelos desenvolvedores.

Arquivos da release:

- `InfiniteFusionPTBRInstaller-v1.1.0.exe`: instalador grafico recomendado em arquivo unico. Nenhum arquivo `.bat` e incluido neste download.
- `PTBR-Translation-BAT-v1.1.0.zip`: pacote BAT/PowerShell separado com tutorial de script e auxiliar de restauracao.
